...
message(STATUS "control_pkg: 0 messages, 1 services")
...
get_filename_component(_filename "/home/chao/ROV_code/src/control_pkg/srv/servo_control.srv" NAME_WE)
add_custom_target(_control_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control_pkg" "/home/chao/ROV_code/src/control_pkg/srv/servo_control.srv" ""
)
...
### Generating Services
_generate_srv_cpp(control_pkg
  "/home/chao/ROV_code/src/control_pkg/srv/servo_control.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_lisp(control_pkg
  "/home/chao/ROV_code/src/control_pkg/srv/servo_control.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(control_pkg
  "/home/chao/ROV_code/src/control_pkg/srv/servo_control.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_pkg\")")
  # install generated code
  install(
